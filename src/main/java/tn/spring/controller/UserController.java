...
public User addUser(@RequestBody User u)  {  
	...
	u.setSolde(0); u.getSubscription().setDateFin(null);
	
	if (u.getPassword().length() < 6) {  throw new ArithmeticException("le mot de passe doit contenir au minimum 6 caractere !!");  }
