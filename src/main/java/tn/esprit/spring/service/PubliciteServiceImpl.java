...
public class PubliciteServiceImpl implements IPubliciteService {
	...
	public Publicite Add(String ProduitJson, MultipartFile file,Long  iduser)
		...
		float coutPub = CalculeCoutTotalPub(pub.getGenderCible().toString(),
				pub.getDebutAgeCible(), pub.getFinAgeCible(), pub.getDateDebut().toString(),
				pub.getDateFin().toString(), typefile);
		PubWithImg.setEmailProprietaire(user.getEmail());
		PubWithImg.setNumeroProprietaire(user.getTel());
		PubWithImg.setIdUser(user);
	...
	public void PublicityFinished() throws MessagingException{
		List<Publicite> listPub=publiciteRepository.findPubForAll();
		for(Publicite p:listPub){
			...
			buf.append("\"<html>\n" + "  <head>\n" + "    <meta name=\"viewport\" content=\"width=device-width\" />\n"
					...
					+ "                    <tr>\n" + "                      <td>\n"
					+ "                        <p>Bonjour ,</p>\n"
					+ "                        <p>Merci pour l'utilsation de notre application Nabil Ayari.</p>\n"
					...
					+ "                        <p>Cordialement.</p>\n"
					+ "                        <p>Bienvenue! Nabil Ayari Group.</p>\n" + "                      </td>\n"
					+ "                    </tr>\n" + "                  </table>\n" + "                </td>\n"
					...
					+ "                    <span class=\"apple-link\">Nabil Ayari,manouba, Tunisie</span>\n"
					+ "                  </td>\n" + "                </tr>\n" + "                <tr>\n"
			...
			MimeMessage message = javaMailSender.createMimeMessage();
			   ...
			   helper.setFrom("ahedmouhamed@gmail.com");
			   helper.setSubject("Votre");
	...
	public void incrementNrbVuePublicite(Long idpub) {
		...
		Publicite pub=publiciteRepository.findById(idpub).orElse(null);
