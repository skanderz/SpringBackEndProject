...
import tn.esprit.configuration.OpenNLP;
...
public class ReclamationServiceImpt implements ReclamationService {
	...
	public void traiter(Long rec, String reponse) {
		...
		mailMessage.setTo(recTotraiter.getCondidat().getEmail() );
		mailMessage.setSubject("traiter !");
		mailMessage.setFrom("ahedmouhamed@gmail.com");
		mailMessage.setText(recTotraiter.getReponse());
