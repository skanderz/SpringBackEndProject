...
public class ReclamationController {
	...
	@PostMapping("/create/{condidatid}/{idoffre}")
	public  ResponseEntity<?> create(@RequestBody Reclamation rec, @PathVariable Long condidatid, @PathVariable Long idoffre) {
		String [] wordsFromText = rec.getDescription().split(" ");
		
		 if (reclamationService.badWordsValidation(wordsFromText))
		 {
	            return ResponseEntity.ok(reclamationService.create(rec, condidatid, idoffre));
