	  ...
	  private static void loadBadWords() {
	    ...
	    try {
	      ...
	      // (If the spreadsheet ever ceases to exist, then this application will still function normally otherwise - it just won't censor any swear words.)
	    	...
	    	InputStreamReader inputStreamReader= new InputStreamReader(new URL( "https://docs.google.com/spreadsheets/d/1hIEi2YG3ydav1E06Bzf2mQbGZ12kh2fe4ISgLg_UBuM/export?format=csv").openConnection().getInputStream());
